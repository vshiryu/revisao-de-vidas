...
const audioFiles = [
  "mp3/Bondade de Deus_ Piano Instrumental.mp3",
  "mp3/Porque Ele Vive_ Instrumental, Piano e Vocalize.mp3",
  "mp3/RUJA O LEÃO - TALITA CATANZARO - PLAYBACK (legendado).mp3",
  "mp3/Yeshua (Instrumental Piano).mp3",
];
...
function playRandomMusic() {
  ...
  currentAudio.src = audioFiles[randomIndex];
